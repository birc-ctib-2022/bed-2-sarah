...
cmd2 = 'python3.10 sort_bed.py infile=data/input.bed outfile=data/test-sorted-1.bed' #A string with the command to generate our test output
...
cmd2 = 'python3.10 sort_bed.py infile=data/large.bed outfile=data/test-sorted-2.bed' #A string with the command to generate our test output
os.system(cmd1) #Calling our commands
os.system(cmd2)
